...
and then independently corroborate every candidate against the current files. Recheck snapshot
stability before reporting. Never substitute a diff-only or same-context self-review.
